//
//A Java Hash Class
//Including Constructors and Methods for Dealing with Hash Values
//
//Copyright (c)1996 Robert Uzgalis, All Rights Reserved.
//
...
public class Hash
{
   ...
   {
      this.hash_code = mix_master[(((arg)) + 183) & 0xff];
   }
   ...
   public boolean more(Hash b) // Test Hash Value a bigger than b
   {
      if ((this.hash_code >>> 1) > (b.hash_code >>> 1))
         ...
         return (this.hash_code & 0x1) > (b.hash_code & 0x1);
   }
