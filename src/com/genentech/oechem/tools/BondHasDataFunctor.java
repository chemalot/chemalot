 ...
 *
 */
public class BondHasDataFunctor extends OEUnaryBondPred {

   private final int property;
   
   public BondHasDataFunctor(int property) {
   ...
   public boolean constCall(OEBondBase bd) {
      return ( bd.HasData(property) ) ;
   }
   
   @Override
   public OEUnaryBondBoolFunc CreateCopy( ) {
      OEUnaryBondBoolFunc copy = new BondHasDataFunctor(property);
