...
class AtomStereoNonChiralFunctor extends OEUnaryAtomPred {

   public AtomStereoNonChiralFunctor() {
   }
   
   public boolean constCall(OEAtomBase at) {
      return at.HasStereoSpecified() && ! at.IsChiral();
   }
   
   public OEUnaryAtomBoolFunc CreateCopy( ) {
      OEUnaryAtomBoolFunc copy = new AtomStereoNonChiralFunctor();
