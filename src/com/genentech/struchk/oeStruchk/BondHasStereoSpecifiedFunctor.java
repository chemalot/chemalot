...
class BondHasStereoSpecifiedFunctor extends OEUnaryBondPred {

   public BondHasStereoSpecifiedFunctor () {
   }
   
   public boolean constCall(OEBondBase bd) {
      return bd.HasStereoSpecified();
   }
   
   public OEUnaryBondBoolFunc CreateCopy( ) {
      BondHasStereoSpecifiedFunctor copy = new BondHasStereoSpecifiedFunctor ();
