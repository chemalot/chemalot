 ...
 *
 * This implementation uses a char to store a path.
 * @author albertgo
 *
 */
public class IAAPathGeneratorChar
{  private static final int MAXAtomType = Prime.getPrimeLargerEqThan(217);
   ...
   IAAPathGeneratorChar(OEMolBase mol, int maxBonds)
    ...
    */
   public char[] getAtomPaths(OEAtomBase at)
   {  pathList.clear();
      ...
      char[] paths = new char[pathList.size()];
      for( int i=0; i<pathList.size(); i++ )
         paths[i] = (char)pathList.get(i).intValue();
