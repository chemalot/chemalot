 ...
 *
 * This implementation uses a int to store a path.
 * @author albertgo
 *
 */
public class IAAPathGeneratorInt
{  private static final int MAXAtomType = Prime.getPrimeLargerEqThan(217);
   ...
   IAAPathGeneratorInt(OEMolBase mol, int maxBonds)
    ...
    */
   public int[] getAtomPaths(OEAtomBase at)
   {  pathList.clear();
      ...
      int[] paths = new int[pathList.size()];
